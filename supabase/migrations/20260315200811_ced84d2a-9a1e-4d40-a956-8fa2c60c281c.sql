...
CREATE TABLE public.profiles (
  ...
  fishing_method_id UUID REFERENCES public.fishing_methods(id),
...
-- Fishing methods: readable by everyone
CREATE POLICY "Fishing methods are viewable by everyone" ON public.fishing_methods FOR SELECT USING (true);

-- Ranks: readable by everyone
